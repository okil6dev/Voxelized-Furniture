...
public class VoxelizedFurnitureMod implements ModInitializer {
	public static final Logger LOGGER = LogManager.getLogger(VoxelizedFurnitureMod.class);
	public static final String MODID = "voxelized_furniture";

	@Override
	public void onInitialize() {
		// Start of user code block mod constructor
		// End of user code block mod constructor
		LOGGER.info("Initializing VoxelizedFurnitureMod");
		VoxelizedFurnitureModSounds.load();
		VoxelizedFurnitureModTabs.load();
		VoxelizedFurnitureModVariables.variablesLoad();
		VoxelizedFurnitureModFeatures.load();
		VoxelizedFurnitureModParticleTypes.load();
		VoxelizedFurnitureModEntities.load();
		VoxelizedFurnitureModBlocks.load();
		VoxelizedFurnitureModBlockEntities.load();
		VoxelizedFurnitureModItems.load();
		VoxelizedFurnitureModMenus.load();
		tick();
