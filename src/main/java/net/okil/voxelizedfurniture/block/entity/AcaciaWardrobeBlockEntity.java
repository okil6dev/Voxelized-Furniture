...
public class AcaciaWardrobeBlockEntity extends RandomizableContainerBlockEntity implements WorldlyContainer {
	private NonNullList<ItemStack> stacks = NonNullList.withSize(8, ItemStack.EMPTY);

	public AcaciaWardrobeBlockEntity(BlockPos position, BlockState state) {
		super(VoxelizedFurnitureModBlockEntities.ACACIA_WARDROBE, position, state);
	}
	...
	public Component getDefaultName() {
		return Component.literal("acacia_wardrobe");
	}
