...
public class KitchenDrawer1BlockEntity extends RandomizableContainerBlockEntity implements WorldlyContainer {
	private NonNullList<ItemStack> stacks = NonNullList.withSize(18, ItemStack.EMPTY);

	public KitchenDrawer1BlockEntity(BlockPos position, BlockState state) {
		super(VoxelizedFurnitureModBlockEntities.KITCHEN_DRAWER_1, position, state);
	}
	...
	public Component getDefaultName() {
		return Component.literal("kitchen_drawer_1");
	}
