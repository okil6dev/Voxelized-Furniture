...
public class KitchenSinkBlockEntity extends RandomizableContainerBlockEntity implements WorldlyContainer {
	private NonNullList<ItemStack> stacks = NonNullList.withSize(18, ItemStack.EMPTY);

	public KitchenSinkBlockEntity(BlockPos position, BlockState state) {
		super(VoxelizedFurnitureModBlockEntities.KITCHEN_SINK, position, state);
	}
	...
	public Component getDefaultName() {
		return Component.literal("kitchen_sink");
	}
