...
public class OvenBlockEntity extends RandomizableContainerBlockEntity implements WorldlyContainer {
	...
	public OvenBlockEntity(BlockPos position, BlockState state) {
		super(VoxelizedFurnitureModBlockEntities.OVEN, position, state);
	}
	...
	public AbstractContainerMenu createMenu(int id, Inventory inventory) {
		return new CookingGuiMenu(id, inventory, this, new FriendlyByteBuf(Unpooled.buffer()).writeBlockPos(this.worldPosition));
	}
