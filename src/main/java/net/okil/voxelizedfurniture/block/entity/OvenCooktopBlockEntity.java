...
public class OvenCooktopBlockEntity extends RandomizableContainerBlockEntity implements WorldlyContainer {
	private NonNullList<ItemStack> stacks = NonNullList.withSize(18, ItemStack.EMPTY);

	public OvenCooktopBlockEntity(BlockPos position, BlockState state) {
		super(VoxelizedFurnitureModBlockEntities.OVEN_COOKTOP.get(), position, state);
	}
	...
	public Component getDefaultName() {
		return Component.literal("oven_cooktop");
	}
