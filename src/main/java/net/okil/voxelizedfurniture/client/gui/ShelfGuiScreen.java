...
public class ShelfGuiScreen extends AbstractContainerScreen<ShelfGuiMenu> implements VoxelizedFurnitureModScreens.ScreenAccessor {
	...
	private static final ResourceLocation BACKGROUND = ResourceLocation.parse("voxelized_furniture:textures/screens/shelf_gui.png");
	private static final ResourceLocation IMAGE_0 = ResourceLocation.parse("voxelized_furniture:textures/screens/shelfgui.png");
	...
	protected void renderBg(GuiGraphics guiGraphics, float partialTicks, int mouseX, int mouseY) {
		...
		guiGraphics.blit(IMAGE_0, this.leftPos + 57, this.topPos + 7, 0, 0, 60, 7, 60, 7);
