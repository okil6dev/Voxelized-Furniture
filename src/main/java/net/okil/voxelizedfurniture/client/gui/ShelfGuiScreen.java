...
public class ShelfGuiScreen extends AbstractContainerScreen<ShelfGuiMenu> implements VoxelizedFurnitureModScreens.ScreenAccessor {
	...
	private static final ResourceLocation texture = ResourceLocation.parse("voxelized_furniture:textures/screens/shelf_gui.png");
	...
	protected void renderBg(GuiGraphics guiGraphics, float partialTicks, int mouseX, int mouseY) {
		...
		guiGraphics.blit(RenderPipelines.GUI_TEXTURED, ResourceLocation.parse("voxelized_furniture:textures/screens/shelfgui.png"), this.leftPos + 57, this.topPos + 7, 0, 0, 60, 7, 60, 7);
	}
