...
public class AcaciaChairEntity extends PathfinderMob {
	...
	protected void dropCustomDeathLoot(ServerLevel serverLevel, DamageSource source, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(serverLevel, new ItemStack(VoxelizedFurnitureModBlocks.ACACIA_CHAIR_1.get()));
	}
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		AcaciaChairEntityIsRightclickedProcedure.execute(world, x, y, z, entity, sourceentity);
		return retval;
	}
	...
	public static void init(RegisterSpawnPlacementsEvent event) {
		event.register(VoxelizedFurnitureModEntities.ACACIA_CHAIR.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
