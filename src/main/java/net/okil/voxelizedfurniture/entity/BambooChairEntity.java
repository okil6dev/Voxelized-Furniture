...
import net.okil.voxelizedfurniture.procedures.BambooChairEntityIsRightclickedProcedure;
...
public class BambooChairEntity extends PathfinderMob {
	public BambooChairEntity(EntityType<BambooChairEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(true);
	...
	protected void dropCustomDeathLoot(ServerLevel serverLevel, DamageSource source, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(serverLevel, new ItemStack(VoxelizedFurnitureModBlocks.BAMBOO_CHAIR_1.get()));
	}
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		BambooChairEntityIsRightclickedProcedure.execute(world, x, y, z, entity, sourceentity);
		return retval;
	}
	...
	public static void init(RegisterSpawnPlacementsEvent event) {
		event.register(VoxelizedFurnitureModEntities.BAMBOO_CHAIR.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
