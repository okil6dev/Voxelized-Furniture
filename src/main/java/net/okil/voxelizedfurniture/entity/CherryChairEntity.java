...
import net.okil.voxelizedfurniture.procedures.CherryChairEntityIsRightclickedProcedure;
...
public class CherryChairEntity extends PathfinderMob {
	public CherryChairEntity(EntityType<CherryChairEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(true);
	...
	protected void dropCustomDeathLoot(ServerLevel serverLevel, DamageSource source, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(serverLevel, new ItemStack(VoxelizedFurnitureModBlocks.CHERRY_CHAIR_1.get()));
	}
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		CherryChairEntityIsRightclickedProcedure.execute(world, x, y, z, entity, sourceentity);
		return retval;
	}
	...
	public static void init(RegisterSpawnPlacementsEvent event) {
		event.register(VoxelizedFurnitureModEntities.CHERRY_CHAIR.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
