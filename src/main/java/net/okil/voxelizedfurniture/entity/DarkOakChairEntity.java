...
import net.okil.voxelizedfurniture.procedures.DarkOakChairEntityIsRightclickedProcedure;
...
public class DarkOakChairEntity extends PathfinderMob {
	public DarkOakChairEntity(EntityType<DarkOakChairEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(true);
	...
	protected void dropCustomDeathLoot(ServerLevel serverLevel, DamageSource source, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(serverLevel, new ItemStack(VoxelizedFurnitureModBlocks.DARK_OAK_CHAIR_1.get()));
	}
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		DarkOakChairEntityIsRightclickedProcedure.execute(world, x, y, z, entity, sourceentity);
		return retval;
	}
	...
	public static void init(RegisterSpawnPlacementsEvent event) {
		event.register(VoxelizedFurnitureModEntities.DARK_OAK_CHAIR.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
