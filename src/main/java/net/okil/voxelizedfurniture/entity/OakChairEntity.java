...
public class OakChairEntity extends PathfinderMob {
	public OakChairEntity(EntityType<OakChairEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(true);
	...
	protected void dropCustomDeathLoot(ServerLevel serverLevel, DamageSource source, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(serverLevel, new ItemStack(VoxelizedFurnitureModBlocks.OAK_CHAIR_1.get()));
	}
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		OakChairEntityIsRightclickedProcedure.execute(world, x, y, z, entity, sourceentity);
		return retval;
	}
