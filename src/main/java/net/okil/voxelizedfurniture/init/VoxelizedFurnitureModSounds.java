...
public class VoxelizedFurnitureModSounds {
	...
	public static final DeferredHolder<SoundEvent, SoundEvent> DOORBELLRING = REGISTRY.register("doorbellring", () -> SoundEvent.createVariableRangeEvent(Identifier.fromNamespaceAndPath("voxelized_furniture", "doorbellring")));
}