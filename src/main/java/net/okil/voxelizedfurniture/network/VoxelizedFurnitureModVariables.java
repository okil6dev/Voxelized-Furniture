...
public class VoxelizedFurnitureModVariables {
	...
	public static class WorldVariables extends SavedData {
		public static final SavedDataType<WorldVariables> TYPE = new SavedDataType<>(Identifier.parse("voxelized_furniture:worldvars"), level -> new WorldVariables(), level -> CompoundTag.CODEC.xmap(tag -> {
	...
	public static class MapVariables extends SavedData {
		public static final SavedDataType<MapVariables> TYPE = new SavedDataType<>(Identifier.parse("voxelized_furniture:mapvars"), level -> new MapVariables(), level -> CompoundTag.CODEC.xmap(tag -> {
