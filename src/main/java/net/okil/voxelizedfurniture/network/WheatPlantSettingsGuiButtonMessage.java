...
public record WheatPlantSettingsGuiButtonMessage(int buttonID, int x, int y, int z) implements CustomPacketPayload {
	public static final Type<WheatPlantSettingsGuiButtonMessage> TYPE = new Type<>(Identifier.fromNamespaceAndPath(VoxelizedFurnitureMod.MODID, "wheat_plant_settings_gui_buttons"));
	...
	public static void handleData(final WheatPlantSettingsGuiButtonMessage message, final ServerPlayNetworking.Context context) {
