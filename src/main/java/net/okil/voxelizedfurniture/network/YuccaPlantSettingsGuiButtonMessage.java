...
public record YuccaPlantSettingsGuiButtonMessage(int buttonID, int x, int y, int z) implements CustomPacketPayload {
	public static final Type<YuccaPlantSettingsGuiButtonMessage> TYPE = new Type<>(ResourceLocation.fromNamespaceAndPath(VoxelizedFurnitureMod.MODID, "yucca_plant_settings_gui_buttons"));
