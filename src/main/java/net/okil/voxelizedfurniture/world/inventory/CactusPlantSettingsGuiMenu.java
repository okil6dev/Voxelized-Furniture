...
public class CactusPlantSettingsGuiMenu extends AbstractContainerMenu implements VoxelizedFurnitureModMenus.MenuAccessor {
	...
	public CactusPlantSettingsGuiMenu(int id, Inventory inv) {
	...
	public CactusPlantSettingsGuiMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
	...
	public CactusPlantSettingsGuiMenu(int id, Inventory inv, Container container, FriendlyByteBuf extraData) {
	...
	public CactusPlantSettingsGuiMenu(int id, Inventory inv, Container container) {
		super(VoxelizedFurnitureModMenus.CACTUS_PLANT_SETTINGS_GUI, id);
	...
	public static void screenInit() {
		PayloadTypeRegistry.serverboundPlay().register(CactusPlantSettingsGuiButtonMessage.TYPE, CactusPlantSettingsGuiButtonMessage.STREAM_CODEC);
		ServerPlayNetworking.registerGlobalReceiver(CactusPlantSettingsGuiButtonMessage.TYPE, CactusPlantSettingsGuiButtonMessage::handleData);
	}
}