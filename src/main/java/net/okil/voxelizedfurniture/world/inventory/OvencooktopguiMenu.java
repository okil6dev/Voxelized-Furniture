...
public class OvencooktopguiMenu extends AbstractContainerMenu implements VoxelizedFurnitureModMenus.MenuAccessor {
	...
	public OvencooktopguiMenu(int id, Inventory inv) {
	...
	public OvencooktopguiMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
	...
	public OvencooktopguiMenu(int id, Inventory inv, Container container, FriendlyByteBuf extraData) {
	...
	public OvencooktopguiMenu(int id, Inventory inv, Container container) {
		super(VoxelizedFurnitureModMenus.OVENCOOKTOPGUI, id);
		this.entity = inv.player;
		this.world = inv.player.level();
		this.inventory = container;
		this.customSlots.put(0, this.addSlot(new Slot(inventory, 0, 7, 10) {
			private final int slot = 0;
			private int x = OvencooktopguiMenu.this.x;
			private int y = OvencooktopguiMenu.this.y;
		}));
		this.customSlots.put(1, this.addSlot(new Slot(inventory, 1, 7, 28) {
			private final int slot = 1;
			private int x = OvencooktopguiMenu.this.x;
			private int y = OvencooktopguiMenu.this.y;
		}));
		this.customSlots.put(2, this.addSlot(new Slot(inventory, 2, 25, 10) {
			private final int slot = 2;
			private int x = OvencooktopguiMenu.this.x;
			private int y = OvencooktopguiMenu.this.y;
		}));
		this.customSlots.put(3, this.addSlot(new Slot(inventory, 3, 25, 28) {
			private final int slot = 3;
			private int x = OvencooktopguiMenu.this.x;
			private int y = OvencooktopguiMenu.this.y;
		}));
		this.customSlots.put(4, this.addSlot(new Slot(inventory, 4, 43, 10) {
			private final int slot = 4;
			private int x = OvencooktopguiMenu.this.x;
			private int y = OvencooktopguiMenu.this.y;
		}));
		this.customSlots.put(5, this.addSlot(new Slot(inventory, 5, 43, 28) {
			private final int slot = 5;
			private int x = OvencooktopguiMenu.this.x;
			private int y = OvencooktopguiMenu.this.y;
		}));
		this.customSlots.put(6, this.addSlot(new Slot(inventory, 6, 61, 10) {
			private final int slot = 6;
			private int x = OvencooktopguiMenu.this.x;
			private int y = OvencooktopguiMenu.this.y;
		}));
		this.customSlots.put(7, this.addSlot(new Slot(inventory, 7, 61, 28) {
			private final int slot = 7;
			private int x = OvencooktopguiMenu.this.x;
			private int y = OvencooktopguiMenu.this.y;
		}));
		this.customSlots.put(8, this.addSlot(new Slot(inventory, 8, 79, 10) {
			private final int slot = 8;
			private int x = OvencooktopguiMenu.this.x;
			private int y = OvencooktopguiMenu.this.y;
		}));
		this.customSlots.put(9, this.addSlot(new Slot(inventory, 9, 79, 28) {
			private final int slot = 9;
			private int x = OvencooktopguiMenu.this.x;
			private int y = OvencooktopguiMenu.this.y;
		}));
		this.customSlots.put(10, this.addSlot(new Slot(inventory, 10, 97, 10) {
			private final int slot = 10;
			private int x = OvencooktopguiMenu.this.x;
			private int y = OvencooktopguiMenu.this.y;
		}));
		this.customSlots.put(11, this.addSlot(new Slot(inventory, 11, 97, 28) {
			private final int slot = 11;
			private int x = OvencooktopguiMenu.this.x;
			private int y = OvencooktopguiMenu.this.y;
		}));
		this.customSlots.put(12, this.addSlot(new Slot(inventory, 12, 115, 10) {
			private final int slot = 12;
			private int x = OvencooktopguiMenu.this.x;
			private int y = OvencooktopguiMenu.this.y;
		}));
		this.customSlots.put(13, this.addSlot(new Slot(inventory, 13, 115, 28) {
			private final int slot = 13;
			private int x = OvencooktopguiMenu.this.x;
			private int y = OvencooktopguiMenu.this.y;
		}));
		this.customSlots.put(14, this.addSlot(new Slot(inventory, 14, 133, 10) {
			private final int slot = 14;
			private int x = OvencooktopguiMenu.this.x;
			private int y = OvencooktopguiMenu.this.y;
		}));
		this.customSlots.put(15, this.addSlot(new Slot(inventory, 15, 133, 28) {
			private final int slot = 15;
			private int x = OvencooktopguiMenu.this.x;
			private int y = OvencooktopguiMenu.this.y;
		}));
		this.customSlots.put(16, this.addSlot(new Slot(inventory, 16, 151, 10) {
			private final int slot = 16;
			private int x = OvencooktopguiMenu.this.x;
			private int y = OvencooktopguiMenu.this.y;
		}));
		this.customSlots.put(17, this.addSlot(new Slot(inventory, 17, 151, 28) {
