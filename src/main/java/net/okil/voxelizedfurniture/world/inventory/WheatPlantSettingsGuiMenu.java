...
public class WheatPlantSettingsGuiMenu extends AbstractContainerMenu implements VoxelizedFurnitureModMenus.MenuAccessor {
	...
	public WheatPlantSettingsGuiMenu(int id, Inventory inv) {
	...
	public WheatPlantSettingsGuiMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
	...
	public WheatPlantSettingsGuiMenu(int id, Inventory inv, Container container, FriendlyByteBuf extraData) {
	...
	public WheatPlantSettingsGuiMenu(int id, Inventory inv, Container container) {
		super(VoxelizedFurnitureModMenus.WHEAT_PLANT_SETTINGS_GUI, id);
	...
	public static void screenInit() {
		PayloadTypeRegistry.serverboundPlay().register(WheatPlantSettingsGuiButtonMessage.TYPE, WheatPlantSettingsGuiButtonMessage.STREAM_CODEC);
		ServerPlayNetworking.registerGlobalReceiver(WheatPlantSettingsGuiButtonMessage.TYPE, WheatPlantSettingsGuiButtonMessage::handleData);
	}
}